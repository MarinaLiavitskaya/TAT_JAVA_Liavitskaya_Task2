...
public class UserControllerImplTest {
	...
	public void test_user_AddBook() {
		...
		String actual = Server.initServer("ADD_BOOK Harry_Potter J.K.Rowling England");
	...
	public void test_user_CancelOrder() {
		...
		String actual = Server.startServer("CANCEL_ORDER 8");
		Assert.assertEquals(actual, expected);
	}
	...
	public void test_user_CancelOrder_negative() {
		...
		Server.startServer("CANCEL_ORDER 11");
		Assert.assertEquals(actual, expected);
	}
	...
	public void test_user_ChangeRole() {
		...
		Server.startServer("CHANGE_ROLE ADMINISTRATOR 5");
		Assert.assertEquals(actual, expected);
	}
